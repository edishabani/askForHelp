...
add_action('widgets_init','roselle_widget_setup');
...
/*
	...
	==========================================
*/
function roselle_remove_version() {
	return '';
}
add_filter('the_generator', 'roselle_remove_version');
...
/*
	...
	==========================================
*/
function roselle_custom_post_type (){
...
add_action('init','roselle_custom_post_type');

function roselle_custom_taxonomies() {
...
add_action( 'init' , 'roselle_custom_taxonomies' );
...
function roselle_get_terms( $postID, $term ){
